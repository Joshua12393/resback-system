...
- Make feedback submission accessible to authenticated CCIS students and faculty.
...
- Profile settings with nickname and profile-photo customization
...
- **Faculty** — submits feedback, views personal feedback history, accesses dashboard analytics, and generates filtered reports.
- **Admin** — accesses analytics, manages Student and Faculty accounts, and can delete feedback.
- **Super Admin** — inherits Admin access, manages administrator roles and statuses, and can delete other accounts.
